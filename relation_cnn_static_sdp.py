...
def train(argv=None):
    ...
    logits = model(train_data_node, train_pf_node, train_sdp_node)
    ...
    def dev_step(x_batch,y_batch,pf_batch,w_batch,best_test_loss,sess):
        ...
        summary,step, losses, lr,acc,y_label,y_predict,test_predicts = sess.run([merged,global_step, loss,learning_rate,train_accuracy,train_label,train_predict,logits]
                                                                   ,feed_dict=feed_dict)
